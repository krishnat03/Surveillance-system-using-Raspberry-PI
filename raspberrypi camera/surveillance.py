...
## Project Name : Home Surveillance Security Camera                 ##
## Year : 2021                                                      ##
## Use this code in notepad++                                       ##
######################################################################
...
Please check the attachement sent from krishna's rasperry pi security system.
...
SMTP_SERVER=constant.SMTPSERVER
SMTP_PORT=constant.SMTPPORT
USERNAME=constant.USERNAME
PASSWORD=constant.PASSWORD
RECIEVER_EMAIL=constant.RECIEVER_EMAIL
